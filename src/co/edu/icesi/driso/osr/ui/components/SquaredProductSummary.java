...
public class SquaredProductSummary extends CustomComponent implements
		ViewComponent<Integer> {
	...
	private void buildMainLayout() {
		...
		quantityField
				.setConversionError("Please specify a numeric value in the quantity field");
